    ...
    <xsl:template match="dri:list/dri:list/dri:list" mode="dsoList" priority="8">
        <li>
            <xsl:attribute name="class">
                <xsl:text>ds-rezultati-item clearfix </xsl:text>
                <xsl:choose>
        ...
        <div class="artifact-description">
            ...
            <div class="artifact-info">
                ...
                <xsl:choose>
                    ...
                    <xsl:when test="dri:list[@n=(concat($handle, ':dc.description'))]/dri:item/dri:hi">
                        <div class="abstract">
                            <xsl:for-each select="dri:list[@n=(concat($handle, ':dc.description'))]/dri:item">
                                <xsl:apply-templates select="."/>
                                <xsl:text>...</xsl:text>
                                <br/>
                            </xsl:for-each>
