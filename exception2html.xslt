  ...
  <xsl:template match="ex:exception-report">
    <html>
      <head>
        ...
        <style>
					html { background: url(/static/icons/depo.jpg) no-repeat center center fixed; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover; filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src='./static/icons/depo.jpg', sizingMethod='scale'); -ms-filter: "progid:DXImageTransform.Microsoft.AlphaImageLoader(src='/static/icons/depo.jpg', sizingMethod='scale')"; font-family:sans-serif; }
					body{margin:0;padding:0;}
          h1 { font-size: 20em; color: #E46252; text-align: center; margin: 55px 0 50px; }
					p { background:#000; margin:0; }
          p.home { text-align:center;background:rgba(0,0,0,0);padding: 10px 30px 10px 15px; margin-bottom: 150px; font-size: 100%; }
          ...
          p.topped { padding-top: 10px; border-width: 1px 0px 0px 0px; border-style: solid; border-color: #336699; }
					p.stacktrace{border-bottom:1px dashed #333;margin:0;padding:0.5em 0;}
					a, a:hover, a:visited {color:#cd6a51;text-decoration:none;}
          span.switch { cursor: pointer; margin-left: 5px; color: #E46252; font-size:1.5em;}
          span.description { color: #E46252; font-weight: bold; color:#999;}          

          table { border-collapse: collapse; margin-top: 0.3em; color:#aaa; font-family:monospace;}
          td { padding: 0.1em; }
					.footer { background:#000; padding:10px 20px 30px;}
					pre { color:#aaa; white-space:pre-wrap;}
					#locations{color: #E46252;}
        </style>
      ...
      <body>
        ...
        <h1>404</h1>
        <p class="home">
          <a href="/"><img src="/static/icons/home.png" title="Dlib.mk Home" alt="Dlib.mk Home" style="margin-right:20px;" /></a>
          <a href="/feedback"><img src="/static/icons/mail.png" title="Contact Dlib.mk" alt="Contact Dlib.mk" style="margin-right:20px;" /></a>
          <a href="/discover"><img src="/static/icons/search.png" title="Search Dlib.mk" alt="Search Dlib.mk" /></a>
        </p>
        <!-- <p class="message">
          ...
          <xsl:if test="ex:location">
             <br/><span style="font-weight: normal"><xsl:apply-templates select="ex:location"/></span>
				...
				<div class="footer">
        <p class="stacktrace"><span class="description">Cocoon stacktrace</span>
           <span class="switch" id="locations-switch" onclick="toggle('locations')">[ - ]</span>
        </p>
        <div id="locations">
